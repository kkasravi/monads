(function() {
  ...
  (function(require, exports, moduleId) {
    ...
    var ColorType = (function() {
      ...
      ColorType.prototype['popback'] = function() {
        return this.stack.pop();
      };
      ColorType.prototype['pushback'] = function(item) {
        this.stack.push(item);
        return this;
      };
      ColorType.prototype['popfront'] = function() {
        return this.stack.shift();
      };
      ColorType.prototype['pushfront'] = function(item) {
