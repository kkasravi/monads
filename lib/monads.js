  ...
  (function(require, exports, moduleId) {
    ...
    var Continuation = (function() {
      ...
      Continuation.prototype['delay'] = function(cps,args,ms) {
        ...
        setTimeout(function () {
          cps.apply(self,vargs);
        },ms);
        return this;
      };
      Continuation.prototype['on'] = function(evt,cb) {
        return this.monad && this.monad.on && this.monad.on(evt,cb);
      };
    ...
    var Monad = (function() {
      ...
      Monad.prototype['on'] = function(events,cb) {
        try {
    ...
    var DOMContinuation = (function() {
      ...
      DOMContinuation.prototype['addClass'] = function(className) {
        try {
          ...
          this.attributes({
            'class':(current.length === 1?current.join(''):current.join(' '))
          });
        } catch(e) {
          log.Logger.error(this,e);
        }
      ...
      DOMContinuation.prototype['animation'] = function(props) {
        try {
          ...
          if(utilities.Environment.webkit) {
            this.style({
              '-webkit-animation':property + ' ' + time + ' ' + count
            });
          } else if(utilities.Environment.firefox) {
            this.style({
              'MozAnimation':property + ' ' + time + ' ' + count
            });
          } else {
            this.style({
              'animation':property + ' ' + time + ' ' + count
            });
          }
        } catch(e) {
          log.Logger.error(this,e);
          ...
          if(attrs.hasOwnProperty(attr)) {
            try {
              if(this.monad && this.monad.element) {
                this.monad.element.setAttribute(attr,attrs[attr]);
              }
            } catch(e) {
              log.Logger.error(this,e);
            }
      ...
      DOMContinuation.prototype['computed'] = function(prop) {
        try {
          var computedValue;
      ...
      DOMContinuation.prototype['fadein'] = function(props) {
        try {
          var properties=props || {};
      ...
      DOMContinuation.prototype['fadeout'] = function(props) {
        try {
          var properties=props || {};
      ...
      DOMContinuation.prototype['parent'] = function() {
        return this.monad.element.parentNode;
      };
      ...
      DOMContinuation.prototype['reflect'] = function(offset) {
        this.monad.element.style.webkitBoxReflect='below ' + offset + '  -webkit-gradient(linear,left top,left bottom,from(transparent),to(rgba(255,255,255,0.25)))';
        return this;
      };
      ...
      DOMContinuation.prototype['rotate'] = function(props) {
      ...
      DOMContinuation.prototype['scale'] = function(factor) {
        try {
          if(utilities.Environment.webkit) {
            this.style({
      ...
      DOMContinuation.prototype['shadowlower'] = function(event) {
        try {
          this.transition({
            property:'box-shadow',
            duration:'0.3s',
      ...
      DOMContinuation.prototype['shadowraise'] = function(event) {
        try {
          this.transition({
            property:'box-shadow',
            duration:'0.3s',
      ...
      DOMContinuation.prototype['size'] = function() {
        ...
        } else if(this.monad.element == window?document.body.scrollLeft >= 0:this.monad.element.scrollLeft >= 0) {
      ...
      DOMContinuation.prototype['slide'] = function(props) {
        try {
          var properties=props || {};
      ...
      DOMContinuation.prototype['zoomin'] = function(props) {
        try {
          var properties=props || {};
      ...
      DOMContinuation.prototype['zoomout'] = function(props) {
        try {
          var properties=props || {};
        ...
        var ctor = function (_properties) {
          ...
          try {
            if(properties.tagName) {
              ...
              Monad.call(this);
              this.element=properties.object.element;
    ...
    var Swipeable = (function() {
      ...
      function Swipeable() {
        ...
        var ctor = function (_properties) {
          ...
          this.source=Selectable([properties.source || properties.target]).elements()[0];
          this.continuationConstructor=SwipeContinuation;
        }
        return ctor.apply(this,args) || this;
      }
      Swipeable.init = (function () {
        try {
          if(utilities.Environment.webkit) {
            var styles=[{
